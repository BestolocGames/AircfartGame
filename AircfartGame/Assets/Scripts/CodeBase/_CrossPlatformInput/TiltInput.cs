// dnSpy decompiler from Assembly-CSharp.dll class: UnityStandardAssets.CrossPlatformInput.TiltInput
using System;
using UnityEngine;
...
namespace UnityStandardAssets.CrossPlatformInput
{
	public class TiltInput : MonoBehaviour
	{
		...
		{
			CrossPlatformInputManager.UnRegisterVirtualAxis(this.mapping.axisName);
